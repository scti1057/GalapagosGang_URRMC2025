...
model_best  = YOLO(os.path.join(os.getcwd(), "results/duckies/duckie-train/weights/best.pt"))   # load the best model
model_last  = YOLO(os.path.join(os.getcwd(), "results/duckies/duckie-train/weights/last.pt"))   # load the latest model

# Run inference on an image
picName = "wDuckiesNear.png"
results = model_best(
